...
Accès restreint aux pages protégées

Structure claire et commentée

🧪 Tests

Le dossier test/ permet de :

vérifier le bon fonctionnement des fonctionnalités

tester les formulaires

valider les traitements PHP
...
Organiser un projet de développement
...
Mise en place d’une architecture MVC complète
